...
project = u'pgRoutingLayer'
copyright = u'2018, pgRouting team'
...
latex_documents = [
  ('index', 'pgRoutingLayer.tex', u'pgRoutingLayer Documentation',
   u'pgRouting team', 'manual'),
]
...
man_pages = [
    ('index', 'TemplateClass', u'pgRoutingLayer Documentation',
     [u'foo'], 1)
]
